...
print(xxxx {}".format(nnnn)) # o texto xxxxx é seguido pela variável (nnnn) no lugar das chaves {}
print(xxxx {} xx {}".format(nnnn, mmm)) # é possível fazer 2 inserções de variáveis, sempre em ordem
...
#          123456789012  # essa é a ID q ele dá aos characters da coleção
 string = "hello world!"
# h = string[0]
# ! = string[-1]
hello = string[0:5]
# !!! é non-inclusive!!! ou seja

enumerate()  # quebra uma coleção em cada um de seus valores e seus indexes
...
a = "asdf" # a maior parte das funções funcionam para listas e strings. A marcação de indexes, p.ex. é igual.

asdf[::2] # Serve para criar uma nova coleção a partir dos elementos de outra coleção. Pegando elementos de dois em dois.
# asdf = [1,2,3,4]   responde    1, 3
...
# IMPORTANTE: ORDER é diferente de SORT   -> Os eementos podem ser srted em outra ordem!
...
for posiç, char in enumerate(lista_x) # o for reconhece dois "parâmetros" em enumerate(). O index e o caracter.
